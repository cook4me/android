...
class RecipeFeedServiceTest {
    ...
    @Test
    fun getRecipesWithNotesReturnsListOfRecipesWithNotes() = runTest {
    ...
    @Test
    fun getRecipeWithNoNoteReturnsDefaultNote() = runTest {
        coEvery { mockRecipeRepository.getAll() } returns mapOf("id1" to Recipe(), "id2" to Recipe())
    ...
    @Test
    fun notLoggedInUserDoesntUpdateNotes() = runTest {
        val recipeId = "id1"
    ...
    @Test
    fun updateExistingRecipeNoteUpdatesNotes() = runTest {
        val recipeId = "id1"
        coEvery { mockRecipeNoteRepository.getRecipeNote(recipeId) } returns 2
    ...
    @Test
    fun updatingNonExistingRecipeNoteCreatesNote() = runTest {
        val recipeId = "id1"
        coEvery { mockAccountService.getCurrentUserWithEmail() } returns "email"
    ...
    @Test
    fun getRecipePersonalVotesWithNoUserReturnsEmptyMap() = runTest {
        coEvery { mockAccountService.getCurrentUserWithEmail() } returns null
    ...
    @Test
    fun getRecipePersonalVotesWithUserReturnsMap() = runTest {
        coEvery { mockAccountService.getCurrentUserWithEmail() } returns "email"
